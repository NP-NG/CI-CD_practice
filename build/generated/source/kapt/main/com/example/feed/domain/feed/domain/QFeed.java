...
public class QFeed extends EntityPathBase<Feed> {
    ...
    private static final long serialVersionUID = -1336493501L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QFeed feed = new QFeed("feed");

    public final com.example.feed.global.entity.QBaseEntity _super = new com.example.feed.global.entity.QBaseEntity(this);
    ...
    public final com.example.feed.domain.user.domain.QUser user;
    ...
    public QFeed(Class<? extends Feed> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.example.feed.domain.user.domain.QUser(forProperty("user")) : null;
    }
